...
module Transparency =
  ...
  let renderWaterGlass () =
    ...
    let glassWaterTex = mkMatTexture (mkTransparent glassColour waterColour glassIOR waterIOR)
    ...
    let glass = subtraction 
                 ...
                 (mkSolidCylinder (mkPoint 0.0 (0.002 + height - (edge/2.)) 0.0) (radius-thickness) (edge + 0.002) glassTex glassTex glassTex)
