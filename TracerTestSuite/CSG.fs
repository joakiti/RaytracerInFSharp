...
module CSG =
  ...
  let spheree () = mkSphere (mkPoint 0.0 0.0 0.0) 0.9 (mkMatTexture (mkPhongMaterial (fromColor Color.Blue) 0.9 (fromColor Color.Blue) 0.9 (fromColor Color.White) 1.3 10))
